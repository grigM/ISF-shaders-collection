/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#52088.0"
}
*/
...
void main () {
	...
	color *= 0.5 + 0.8 * cos (random + random * TIME + TIME + 3.14159 * 0.); // * texture (iChannel0, vec2 (0.7)).x);
