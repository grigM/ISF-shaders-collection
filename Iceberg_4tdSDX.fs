/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/4tdSDX by otaviogood.  I had a lot of trouble getting the snow to look right. It's good enough, but it could still be better.",
  "INPUTS" : [
    {
      "NAME" : "iMouse",
      "TYPE" : "point2D"
...
vec3 RayTrace(in vec2 fragCoord )
{
    ...
    // debugging camera
    float mx=-iMouse.x/RENDERSIZE.x*PI*2.0;
	float my=iMouse.y/RENDERSIZE.y*3.14*0.95 + PI/2.0;
...
void BlockRender(in vec2 fragCoord)
{
    ...
    vec2 blockRes = floor(RENDERSIZE.xy / blockSize) + vec2(1.0);
    // ugly bug with mod.
