/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#47791.0"
}
*/
...
float tri2(vec2 pos)
{
	float a = dot(pos, vec2(sin( 10.0*DEG2RAG), cos( 10.0*DEG2RAG)));
	float b = dot(pos, vec2(sin(-10.0*DEG2RAG), cos(-10.0*DEG2RAG)));	
	float c = -pos.y;
