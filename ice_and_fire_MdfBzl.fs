/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/MdfBzl by mattz.  I've been seeing lots of trendy triangle-based backgrounds and wallpapers over the past 2 years, and I never saw a Shadertoy version, so here's my take. Next step: terrain marching a similar pattern...",
  "INPUTS" : [
...
void main() {
    ...
    float scl = 4.1 / RENDERSIZE.y;
    
    // get 2D scene coords
    vec2 p = (gl_FragCoord.xy - 0.5 - 0.5*RENDERSIZE.xy) * scl;
