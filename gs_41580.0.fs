/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#41580.0"
}
*/
...
#define brightness -0.93
#define darkmatter 1.900
#define distfading 0.060
#define saturation 0.100
