/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#48329.0"
}
*/
...
void main(void){
	vec2 v = (gl_FragCoord.x - RENDERSIZE/2.0) / min(RENDERSIZE.y,RENDERSIZE.x) * 5.0;
	...
	vec2 b = gl_FragCoord.xy/(RENDERSIZE);
