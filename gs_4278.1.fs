/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#4278.1"
}
*/
...
void main(){
  ...
  vec2 p=vec2(0.0,0.0);
  p.x=gl_FragCoord.x/RENDERSIZE.y-0.5*RENDERSIZE.x/RENDERSIZE.y;
  p.y=gl_FragCoord.y/RENDERSIZE.y-0.5;
