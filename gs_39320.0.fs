/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#39320.0"
}
*/
...
{
	t*=pi;
	vec2 pos = vv_FragNormCoord;//vec2 pos = (gl_FragCoord.xy*2.0 - RENDERSIZE.xy) / RENDERSIZE.y;
