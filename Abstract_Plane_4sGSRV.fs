/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/4sGSRV by Shane.  Using a randomized 3D tile to add some pronounced surfacing to a warped plane.",
  "INPUTS" : [
    {
      "NAME" : "iMouse",
      "TYPE" : "point2D"
...
void main() {
	...
	// Camera Setup.
	vec3 lk = vec3(0, 3.5, TIME*6.);  // "Look At" position.
