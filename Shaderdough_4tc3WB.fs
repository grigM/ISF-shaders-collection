/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/4tc3WB by tdhooper.  Offsetting the centre of the icosahedron-twist operation gives some fun results.",
  "INPUTS" : [
    {
      "NAME" : "iMouse",
      "TYPE" : "point2D"
...
vec3 render( Hit hit , vec3 ro , vec3 rd ){
    ...
    vec2 pp = (-RENDERSIZE.xy + 2.0*ffragCoord.xy)/RENDERSIZE.y;
