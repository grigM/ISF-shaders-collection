...
void main() {
    ...
    for (float i=1.; i>0.; i-=.01)  {
        ...
        if (x<0.) {  
            // if (x<0.) { gl_FragColor=gl_FragColor-gl_FragColor; return; }
