/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/4sf3zX by knighty.  Triangle groups tilings generator.",
  "INPUTS" : [
...
void main()
{
	...
	vec2 uv = scaleFactor*(gl_FragCoord.xy-0.5*RENDERSIZE.xy) / RENDERSIZE.y;
	aaScale=0.5*scaleFactor/RENDERSIZE.y;
	animUVW(0.5*PI*TIME);
	init(); 
